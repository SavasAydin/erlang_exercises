...
description_and_usage()
{
    cat <<EOF
==================================================
Write a program that finds the index of first occurrence of an element in a list.
...
==================================================
	...
	MODULE_NAME:${EXERCISE_FILE}(3, [1,3,2,4,3]) returns 2
